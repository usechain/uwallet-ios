...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CXDatePickerView/CXDatePickerView.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/FlickerNumber/FlickerNumber.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/GRDB.swift/GRDB.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/HSCryptoKit/HSCryptoKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/HSHDWalletKit/HSHDWalletKit.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/ISO8601DateFormatter/ISO8601DateFormatter.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/InputKit/InputKit.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/LLKit/LLKit.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/QiQRCode/QiQRCode.framework"
